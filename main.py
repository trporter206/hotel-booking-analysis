...
plt.figure(figsize=(6,4))
sns.lineplot(x='month', y='guests', data=full_guests, hue='hotel', hue_order=["City Hotel", "Resort Hotel"], size="hotel", sizes=(2.5, 2.5), sort=False)
...
city_segment_fig = px.pie(city_segments_data,
                          values=city_segments_data['count'],
                          names=city_segments_data['market segment'],
                          title='City bookings per market segment',
                          template='seaborn')
city_segment_fig.update_traces(rotation=-90, textinfo="percent+label")

resort_segment_fig = px.pie(resort_segments_data,
                          values=resort_segments_data['count'],
                          names=resort_segments_data['market segment'],
                          title='Resort bookings per market segment',
                          template='seaborn')
resort_segment_fig.update_traces(rotation=-90, textinfo="percent+label")

# city_segment_fig.show()
# resort_segment_fig.show()
